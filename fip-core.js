...
function renderManager(){
  ...
  overlay.innerHTML=`<div class="fip-manager">
    <header><div><h2>Al Laith Finance Intelligence Platform</h2><p>FIP 6.5.7 · Opening Balance & Table Alignment</p></div><button data-close>×</button></header>
...
function managerButton(){
  ...
  b.innerHTML='<span>FIP</span><small>6.5.7</small>';b.title='Open FIP 6.5.7';b.onclick=renderManager;
}
function styles(){
