...
function renderManager(){
  ...
  overlay.innerHTML=`<div class="fip-manager">
    <header><div><h2>Al Laith Finance Intelligence Platform</h2><p>FIP 6.2.6 · Phased Refresh</p></div><button data-close>×</button></header>
...
function managerButton(){
  ...
  b.innerHTML='<span>FIP</span><small>6.2.6</small>';b.title='Open FIP 6.2.6';b.onclick=renderManager;
}
function styles(){
